...
def times_update():
    ...
    screen.blit(times_sur,
                (bg_x - times_sur.get_width() - 10, 10))  # 將次數文字貼到視窗的右上角
...
def mouse_update():
    ...
    screen.blit(hammer,
                (mouse_pos[0] - 15, mouse_pos[1] - 15))  # 讓鎚子的中心點在滑鼠的位置
...
gophers2 = pygame.image.load("Gophers2_150.png")  #地屬圖片
